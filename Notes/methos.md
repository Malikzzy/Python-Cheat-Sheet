...
## Extrea 
* you can use pow() to raise something to the power instead of **
...
* 
## Return 
* Use the return to do exactly that return a value when defining a fuction
* Example ``` def main (n)``` return n *n
